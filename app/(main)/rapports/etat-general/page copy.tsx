          ...
          <Card>
            ...
            <CardContent className="space-y-4">
              ...
              <div className="space-y-2">
                ...
                <div className="flex flex-wrap gap-2">
                  <Button variant="outline" size="sm" onClick={toggleAllSites}>
              ...
              {/* Filtre par parc */}
              <div className="space-y-2">
                <div className="text-sm font-medium">Parcs</div>
                <div className="flex flex-wrap gap-2">
                  <Button variant="outline" size="sm" onClick={toggleAllParcs}>
              ...
              <div className="space-y-2">
                <div className="text-sm font-medium">Types de Parc</div>
                <div className="flex flex-wrap gap-2">
                  <Button
                    variant="outline"
                    size="sm"
